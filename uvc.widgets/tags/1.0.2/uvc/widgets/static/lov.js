...
//
    lov_dialog:function(params){
        ...
        var dlg_div = jQuery('<div></div>').attr('id','lov_dialog').attr('class','modal fade').attr('tabindex','-1').attr('role','dialog').attr('aria-hidden','true')
                .append(jQuery('<div></div>').attr('class','modal-dialog')
                .append(jQuery('<div></div>').attr('class','modal-content')
                ...
                .append(jQuery('<div></div>').attr('id','body').attr('class','modal-body')
                    ...
                    .append(jQuery('<p></p>').append(jQuery('<input></input>').attr('id','search').attr('class','field field-textline').attr('type','text').attr('placeholder','Eingabe').attr('style','width: 100%')))
                    .append(jQuery('<p></p>').append(jQuery('<select></select>').attr('id','result').attr('class','field field-textline').attr('name','list').attr('size','10').attr('style','width: 100%')))
                )
        ...
        if (params.dlg_id != undefined) {
            ...
            dlg_button.attr('data-target','#' + params.dlg_id);
